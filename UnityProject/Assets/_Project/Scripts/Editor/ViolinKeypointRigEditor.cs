...
public class ViolinKeypointRigEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.HelpBox(
            ...
            "4) Exporter mirrors missing left-side points from right-side drivers and derives center/neck_end/body_end/chin_anchor when possible.\n" +
            "5) Click Export JSON and point Python --calibration-file to that file.",
            MessageType.Info
        );
